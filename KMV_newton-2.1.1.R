...
#?–®ä½? million dallar(indonesia's equities need to be divided by 1000)
...
results_all=subset(results_all,results_all[,1]!=0)  #delete the empty rows that is caused by repeat
...
#   if (results_all[i,9]=="up"|results_all[i,9]=="down"){
